  ...
  try {
    ...
    (async () => {
      ...
      const results = await Promise.all([
        ...
        relayAcecraftOrderFazercards(order),
        relayAfkJourneyOrderFazercards(order),
        relayBallisticHeroVngOrderFazercards(order),
        relayAceRacerOrderFazercards(order),
        relayAgeOfEmpireMobileOrderFazercards(order),
        relayAzurLaneOrderFazercards(order),
        relayBadlandersOrderFazercards(order),
        relayAsphalt9LegendsOrderFazercards(order),
        relayArenaOfValorOrderFazercards(order),
