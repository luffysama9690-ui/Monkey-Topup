  ...
  try {
    ...
    (async () => {
      ...
      const results = await Promise.all([
        ...
        relayValorantThOrderFazercards(order),
        relayLolThOrderFazercards(order),
        relayCodmSgmyOrderFazercards(order),
        relayGenshinGlobalOrderFazercards(order),
        relayHonkaiStarRailGlobalOrderFazercards(order),
        relayHonkaiImpact3rdAsiaOrderFazercards(order),
        relayArenaBreakoutOrderFazercards(order),
        relayDeltaForceOrderFazercards(order),
        relayEafcMobileMyOrderFazercards(order),
        ...
        relayR6MobileGlobalOrderFazercards(order),
        relayTftMobileThOrderFazercards(order),
